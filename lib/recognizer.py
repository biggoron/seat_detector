...
class HumanRecognizer:
  imagePath = '../data/example6.jpeg'
  modelFullPath = '../models/person_recognizer.pb'
  labelsFullPath = '../models/recognizer_labels.txt'


  def __init__(self, graph_name, labels_name, graph_folder="models/", labels_folder="models/"):
      # Creates graph from saved graph_def.pb.
      graph_path = graph_folder + graph_name
  ...
  def run_inference_on_image():
      ...
      with tf.Session() as sess:
          ...
          top_k = predictions.argsort()[:][::-1]  # Getting top 5 predictions
